...
const CountUp = ({ end, duration = 3000, suffix = '' }) => {
...
const HomePage = () => {
  ...
  const headTitleTH = 'ระบบจำลองผู้ป่วยด้วยโมเดลภาษาไทย';
  ...
  useEffect(() => {
    ...
    const typingInterval = setInterval(() => {
      if (currentIndex <= headTitleTH.length) {
        setDisplayedTitle1(headTitleTH.slice(0, currentIndex));
        currentIndex++;
      } else {
        ...
        <div className="home-content">
          ...
          <div className="stats-section fade-in" style={{ animationDelay: '0.8s' }}>
            ...
            <div className="stat-card">
              ...
              <div className="stat-content">
                <div className="stat-value">
                  <CountUp end={stats.avgTime} duration={1500} suffix=" min" />
                </div>
            ...
            <div className="stat-card">
              ...
              <div className="stat-content">
                <div className="stat-value">
                  <CountUp end={stats.totalCases} duration={1500} />
                </div>
