...
class SimpleChatbotTester:
    ...
    def setup_conversation(self, case_data: Dict[str, Any]) -> str:
        ...
        for q in questions_to_ask:
            question_text = q.get('simulator)', q.get('questions', ''))
        ...
        # สิ่งที่อยากรู้
        ถ้าผู้เข้าสอบถามว่า “มีอะไรถามเพิ่มเติมหรือไม่” ให้มารดาจำลองถามในเรื่องต่อไปนี้ หากผู้เข้าสอบยังไม่ได้พูดถึง
        ลิสต์คำถามที่อยากรู้ (เลือกเพียง 1 หัวข้อเท่านั้น):
        {question_list}
        """
