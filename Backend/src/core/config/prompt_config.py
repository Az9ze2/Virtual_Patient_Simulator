...
class PromptConfig:
    ...
    def extract_data_and_build_prompt_01(case_data: Dict[str, Any], question_limit_rule: str, question_list: str, dialogue_examples: str) -> str:
        ...
        - ถ้าหากผู้เข้าสอบถามว่า "ป่วยเป็นอะไร" หรือ ถามถึงอาการของคุณ หากคุณไม่ได้ป่วย ให้ตอบเหตุผลที่มาโรงพยาบาลแทน
        - ถ้าผู้เข้าสอบถามเรื่องที่ไม่เกี่ยวข้องกับทางการแพทย์ ให้ตอบกลับอย่างสุภาพ เช่น "ขอโทษค่ะ ดิฉันมาโรงพยาบาลเพราะลูกมีอาการป่วยค่ะ"
